...
class ESAJDetailsHandler(AbstractHandler):
    def parse(self, soup: BeautifulSoup) -> dict:
        ...
        # --- AREA ---
        area = _clean(soup.find('div', id='areaProcesso').text) if soup.find('div', id='areaProcesso') else None
        ...
        # --- VALOR DA ACAO ---
        valor = None
        valor_element = soup.find('div', id='valorAcaoProcesso')
        if valor_element:
